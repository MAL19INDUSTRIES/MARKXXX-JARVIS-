...
def _save_file(path: Path, content: str, context: str = "Generated by JARVIS code_helper.") -> str:
    try:
...
def _take_screenshot() -> Path | None:
    try:
        ...
        mark_created_file(
            screenshot_path,
            "Screenshot captured by JARVIS code_helper for screen debugging.",
        )
...
def _build(description, language, output_path, args, timeout, speak=None, player=None) -> str:
    ...
    for attempt in range(1, MAX_BUILD_ATTEMPTS + 1):
        ...
        try:
            ...
            _save_file(path, code, f"Auto-fixed generated code for request: {description}")
        except Exception as e:
...
Updated code:"""
    ...
    status = _save_file(Path(file_path), edited, f"Edited existing code file through JARVIS: {instruction}")
