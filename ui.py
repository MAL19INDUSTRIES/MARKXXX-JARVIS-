...
class MainWindow(QMainWindow):
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        lay.addWidget(_sec("VOICE SELECTION"))
        voice_layout = QHBoxLayout()
        voice_label = QLabel("Voice:")
        voice_label.setFont(QFont("Courier New", 7))
        voice_label.setStyleSheet(f"color: {C.TEXT_MED};")
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addWidget(_fl("[F4] Mute  ·  [F11] Fullscreen  ·  [F6] Minimize"))
        lay.addStretch()
        lay.addWidget(_fl("MAL19INDUSTRIES  ·  MARK XXXIX  ·  CLASSIFIED"))
        lay.addStretch()
        lay.addWidget(_fl("© MAL19INDUSTRIES", C.PRI_DIM))
        return w
