...
If any secret files appear as untracked/added, remove them before committing.
...
- [ ] `playwright install` (if using browser tools)
...
If something breaks, copy the console output and note:
...
Then open an issue with those details.
